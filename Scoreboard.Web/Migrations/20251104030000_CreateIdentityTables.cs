...
{
    /// <summary>
    /// Manual migration to create ASP.NET Core Identity tables for MySQL (Pomelo provider).
    /// This complements prior migrations where Identity Up() was empty.
    /// </summary>
    [DbContext(typeof(ContextoMarcador))]
    [Migration("20251104030000_CreateIdentityTables")]
